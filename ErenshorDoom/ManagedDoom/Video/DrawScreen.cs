...
namespace ManagedDoom.Video
{
    public sealed class DrawScreen
    {
        ...
        public void DrawLine(float x1, float y1, float x2, float y2, int color)
        {
            ...
            if (accept)
            {
                var bx1 = MathCompat.Clamp((int)x1, 0, width - 1);
                var by1 = MathCompat.Clamp((int)y1, 0, height - 1);
                var bx2 = MathCompat.Clamp((int)x2, 0, width - 1);
                var by2 = MathCompat.Clamp((int)y2, 0, height - 1);
