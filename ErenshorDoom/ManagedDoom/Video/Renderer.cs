...
namespace ManagedDoom.Video
{
    public sealed class Renderer
    {
        ...
        public Renderer(Config config, GameContent content)
        {
            ...
            config.video_gamescreensize = MathCompat.Clamp(config.video_gamescreensize, 0, MaxWindowSize);
            config.video_gammacorrection = MathCompat.Clamp(config.video_gammacorrection, 0, MaxGammaCorrectionLevel);
